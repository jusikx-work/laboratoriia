...
const questions = [
    {
        question: 'Який заряд має електрон',
        options: [
            'Позитивний',
            'Нейтральний',
            'Негативний',
    ...
    {
        question: 'У ядрі хімічного елемента 33 протони та 43 нейтрони. Який це елемент?',
        options: [
            'Технецій',
            'Уран',
            'Арсен',
    ...
    {
        question: 'У ядрі атома Берилію 4 протони і 5 нейтронів. Скільки електронів в атомі Берилію?',
        options: [
            '1',
            '4',
            '5',
